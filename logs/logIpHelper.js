...
(function () {
    ...
    var Templater = function(){
        ...
        this.addWorkModal = function(el){
            ...
            var initBtn = $('<button>', {
                id: 'show-work-panel-btn',
                class: 'btn btn-info',
                html: '<i class="fa fa-users"></i>'
            }).css({position: 'absolute', bottom: '15px', left: '15px'}).appendTo(el);
    ...
    $(document).ready(function() {
        ...
        new Application(templater, sett, storage).init(sett.body);
        var analizer = new Analizer();

        $('.add-user-in-list').on('click', function () {
        ...
        $('#users-filter-list').on('click', '.remove-user-from-filter', function () {
        ...
        $('#users-filter-list').on('change', '.check-user-in-filter', function () {
        ...
        $('#start-analise-btn').on('click', function () {
